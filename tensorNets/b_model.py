...
class TFIModel:
    ...
    def __init__(self, L, J, g):
        ...
        self.H_mpo = self.generate_H_mpo()

    def generate_H_mpo(self):
        ...
        # setting the entries of W according to the TFI model
        W[0, 0] = self.id
        W[0, 1] = self.sigmax
        ...
        return [W for _ in range(self.L)]  # return a list of W for each bond
